            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'instructions' => 'Canonical film identity for Reviews, Debrief, imports, and optional Ledger links.',
                    ),
                    array(
                        'key'          => 'field_lunara_movie_tmdb_movie_id',
                        'label'        => 'TMDB Movie ID',
                        'name'         => 'tmdb_movie_id',
                        'type'         => 'number',
                        'min'          => 1,
                        'instructions' => 'Secondary provider identity. Imported values remain editable.',
                    ),
                    array(
                        'key'   => 'field_lunara_movie_original_title',
                        'label' => 'Original Title',
                        'name'  => 'original_title',
                        'type'  => 'text',
                    ),
                    array(
                        'key'            => 'field_lunara_movie_release_date',
                        'label'          => 'Release Date',
                        'name'           => 'release_date',
                        'type'           => 'date_picker',
                    ...
                    array(
                        'key'          => 'field_lunara_movie_genres',
                        'label'        => 'Genres',
                        'name'         => 'genres',
                        'type'         => 'text',
                        'instructions' => 'Comma-separated imported genres; editorial changes are preserved on refresh.',
                    ),
                    array(
                        'key'          => 'field_lunara_movie_countries',
                        'label'        => 'Countries',
                        'name'         => 'countries',
                        'type'         => 'text',
                        'instructions' => 'Comma-separated production countries.',
                    ),
                    array(
                        'key'   => 'field_lunara_movie_content_rating',
                        'label' => 'Content Rating',
                        'name'  => 'content_rating',
                        'type'  => 'text',
                    ),
                    array(
                        'key'           => 'field_lunara_movie_backdrop_image',
                        ...
                        'library'       => 'all',
                        'instructions'  => 'Local 16:9 Media Library image used by public Movie and Debrief surfaces.',
                    ),
                    array(
                        'key'   => 'field_lunara_movie_tmdb_backdrop_url',
                        'label' => 'Legacy TMDB Backdrop URL',
                        'name'  => 'tmdb_backdrop_url',
                        'type'  => 'url',
                        'instructions' => 'Legacy reference only. New imports copy approved backdrops into the Media Library.',
                    ),
                    array(
